...
function gene() {
    ...
    return yuzuru.replaceAll( "<br>" , "%0D%0A" ) + '%0D%0A' + motomu.replaceAll( "<br>" , "%0D%0A" ) + torihiki.replaceAll( "<br>" , "%0D%0A" )  +"%0D%0A&hashtags=" + encodeURIComponent('DXTEEN交換');
}
...
function search() {
    yuzuruResult = yuzuruResult.replaceAll( "、" , "%20" );
    motomuResult = motomuResult.replaceAll( "、" , "%20" );
    var query = yuzuruResult.replaceAll( "<br>" , "%20" ) + motomuResult.replaceAll( "<br>" , "%20" ) +"%20%23DXTEEN交換";
